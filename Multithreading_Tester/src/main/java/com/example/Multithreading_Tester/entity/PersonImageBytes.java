...
package com.example.Multithreading_Tester.entity;

import com.example.Multithreading_Tester.enums.MaritalStatus;
import com.example.Multithreading_Tester.enums.Nations;
import com.example.Multithreading_Tester.gRPC.peopleimage.PersonImageBytesProtobufDTO;
...
public class PersonImageBytes {
    ...
    public PersonImageBytesProtobufDTO toPersonImageBytesProtobufDTO() {
        return PersonImageBytesProtobufDTO.newBuilder()
                ...
                .setAge(this.getAge())
                .setNationality(com.example.Multithreading_Tester.gRPC.people.Nations.valueOf(this.getNationality().name()))
                .setCurrentCountry(com.example.Multithreading_Tester.gRPC.people.Nations.valueOf(this.getCurrentCountry().name()))
                .setMaritalStatus(com.example.Multithreading_Tester.gRPC.people.MaritalStatus.valueOf(this.getMaritalStatus().name()))
    ...
    public static PersonImageBytes fromPersonImageBytesProtobufDTO(PersonImageBytesProtobufDTO protobufPersonImageBytes) {
    ...
    public PersonImage toPersonImage() {
        return new PersonImage(this.getId(), this.getIdentificationNumber(), this.getPassportNumber(), this.getEmail(), this.getName(), this.getAge(), this.getNationality(), this.getCurrentCountry(), this.getMaritalStatus(), this.getChildren(), Base64.getEncoder().encodeToString(this.getBiometrics()));
    }

    public static PersonImageBytes fromPersonImage(PersonImage personImage) {
