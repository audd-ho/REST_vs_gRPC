...
import com.example.gRPCAttempt.enums.MaritalStatus;
import com.example.gRPCAttempt.enums.Nations;
import com.example.gRPCAttempt.gRPC.peopleimage.PersonImageProtobufDTO;
...
public class PersonImage {
    ...
    public PersonImage fromPersonImageProtobufDTO(PersonImageProtobufDTO protobufPersonImage) {
        ...
        return new PersonImage(protobufPersonImage.getId(), protobufPersonImage.getIdentificationNumber(), protobufPersonImage.getPassportNumber(), protobufPersonImage.getEmail(), protobufPersonImage.getName(), protobufPersonImage.getAge(), com.example.gRPCAttempt.enums.Nations.valueOf(protobufPersonImage.getNationality().name()), com.example.gRPCAttempt.enums.Nations.valueOf(protobufPersonImage.getCurrentCountry().name()), com.example.gRPCAttempt.enums.MaritalStatus.valueOf(protobufPersonImage.getMaritalStatus().name()), protobufPersonImage.getChildren(), protobufPersonImage.getBiometrics());
    }

    public PersonImageBytes toPersonImageBytes() {
        return new PersonImageBytes(this.getId(), this.getIdentificationNumber(), this.getPassportNumber(), this.getEmail(), this.getName(), this.getAge(), com.example.gRPCAttempt.enums.Nations.valueOf(this.getNationality().name()), com.example.gRPCAttempt.enums.Nations.valueOf(this.getCurrentCountry().name()), com.example.gRPCAttempt.enums.MaritalStatus.valueOf(this.getMaritalStatus().name()), this.getChildren(), Base64.getDecoder().decode(this.getBiometrics()));
    }

    public PersonImage fromPersonImageBytes(PersonImageBytes personImageBytes) {
        return new PersonImage(personImageBytes.getId(), personImageBytes.getIdentificationNumber(), personImageBytes.getPassportNumber(), personImageBytes.getEmail(), personImageBytes.getName(), personImageBytes.getAge(), Nations.valueOf(personImageBytes.getNationality().name()), Nations.valueOf(personImageBytes.getCurrentCountry().name()), MaritalStatus.valueOf(personImageBytes.getMaritalStatus().name()), personImageBytes.getChildren(), Base64.getEncoder().encodeToString(personImageBytes.getBiometrics()));
    }

    public PersonImageBytes toPersonImageBytes_NoID() {
        return new PersonImageBytes(this.getIdentificationNumber(), this.getPassportNumber(), this.getEmail(), this.getName(), this.getAge(), com.example.gRPCAttempt.enums.Nations.valueOf(this.getNationality().name()), com.example.gRPCAttempt.enums.Nations.valueOf(this.getCurrentCountry().name()), com.example.gRPCAttempt.enums.MaritalStatus.valueOf(this.getMaritalStatus().name()), this.getChildren(), Base64.getDecoder().decode(this.getBiometrics()));
    }
