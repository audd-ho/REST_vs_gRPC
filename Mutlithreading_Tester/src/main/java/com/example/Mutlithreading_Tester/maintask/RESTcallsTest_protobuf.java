...
import com.example.Mutlithreading_Tester.service.REST_related.protobuf_related.PeopleImageBytesProtoService;
import com.example.Mutlithreading_Tester.service.REST_related.protobuf_related.PeopleImageStringProtoService;
import com.example.Mutlithreading_Tester.service.REST_related.protobuf_related.PeopleProtoService;
...
public class RESTcallsTest_protobuf implements CommandLineRunner {
    ...
    //public RESTcallsTest(PeopleProtoService peopleProtoService) {this.peopleProtoService = peopleProtoService;};

    private final PeopleImageStringProtoService peopleImageStringProtoService;
    //public RESTcallsTest(PeopleImageStringProtoService peopleImageStringProtoService) {this.peopleImageStringProtoService = peopleImageStringProtoService;};

    private final PeopleImageBytesProtoService peopleImageBytesProtoService;
    //public RESTcallsTest(PeopleImageBytesProtoService peopleImageBytesProtoService) {this.peopleImageBytesProtoService = peopleImageBytesProtoService;};
    ...
    public void run(String... args) throws Exception {
        //peopleProtoService.nationalityJSON(Nations.AT);
