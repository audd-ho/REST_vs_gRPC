...
import com.example.RESTAttempt.dto.protobufTypes.PersonImageBytesProtobufDTO;
...
public class PersonImageBytes {
    ...
    public PersonImageBytesProtobufDTO toPersonImageBytesProtobufDTO() {
        return PersonImageBytesProtobufDTO.newBuilder()
                ...
                .setAge(this.getAge())
                .setNationality(com.example.RESTAttempt.dto.protobufTypes.Nations.valueOf(this.getNationality().name()))
                .setCurrentCountry(com.example.RESTAttempt.dto.protobufTypes.Nations.valueOf(this.getCurrentCountry().name()))
                .setMaritalStatus(com.example.RESTAttempt.dto.protobufTypes.MaritalStatus.valueOf(this.getMaritalStatus().name()))
